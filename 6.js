...
function task6() {
  ...
  new Promise((resolve, reject) => {
    setImmediate(() => {
      ...
      if (randomValue > 0.5) resolve("Більше ніж 0.5");
      else reject("Менше ніж 0.5");
    });
  })
    .then((value) => console.log(`Проміс зарезолвився зі значенням: ${value}`))
    .catch((error) => {
  ...
  // Використовуємо then для обробки зарезолвленого проміса, та виводимо `Проміс зарезолвився зі значенням: ${value}`.
